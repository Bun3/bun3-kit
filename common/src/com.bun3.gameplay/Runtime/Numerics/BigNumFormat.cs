...
namespace Bun3.Gameplay.Numerics
{
    ...
    public enum BigNumOverflowStyle
    {
        ...
        /// <summary>최상위 허용 단위를 유지하고 정수부가 자란다 ("12,345M") —
        /// idlez ToUnitString의 limit 시맨틱.</summary>
        TopUnit,
    }
    ...
    public sealed class BigNumFormat
    {
        ...
        /// ("1.50K", "2.00M" — idlez decimalPlace 스타일).</summary>
        ...
        public BigNumFormat(
            ...
            BigNumOverflowStyle overflowStyle = BigNumOverflowStyle.Scientific)
        {
