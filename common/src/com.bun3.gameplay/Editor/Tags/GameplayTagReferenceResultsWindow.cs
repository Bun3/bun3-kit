...
namespace Bun3.Gameplay.Editor.Tags
{
    internal sealed class GameplayTagReferenceResultsWindow : EditorWindow
    {
        ...
        /// <summary>참조 검색 결과를 text match 목록 창으로 보여 줍니다.</summary>
        /// <param name="result">보여 줄 참조 검색 결과입니다.</param>
        ...
        /// <summary>match 한 건의 표시 문구와 도구 설명을 만듭니다.</summary>
        /// <param name="match">표시할 참조 match입니다.</param>
